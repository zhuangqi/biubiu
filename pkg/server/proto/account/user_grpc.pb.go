...
func (c *userServiceClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserReply, error) {
	...
	err := c.cc.Invoke(ctx, "/account-service.user.userService/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account-service.user.userService/CreateUser",
	}
...
var _UserService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "account-service.user.userService",
