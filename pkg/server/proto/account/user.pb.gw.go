// Code generated by protoc-gen-grpc-apigateway. DO NOT EDIT.
// source: user.proto
...
var (
	pattern_UserService_CreateUser_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "example", "echo"}, "", runtime.AssumeColonVerbOpt(true)))
)
